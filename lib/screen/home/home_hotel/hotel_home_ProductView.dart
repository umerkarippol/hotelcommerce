...
import '../../../homeHotel/editProduct.dart';

class HotelHomProduct_Details extends StatelessWidget {
  CartViewModel controller = Get.put(CartViewModel());
  // const HotelHomProduct_Details({Key? key}) : super(key: key);
  late String image, item_name, description, total, price, product_id;

  HotelHomProduct_Details(
